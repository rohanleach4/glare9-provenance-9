...
- Provider-neutral asynchronous Ed25519 signing with local verification before publication, enabling KMS, HSM and customer-controlled adapters without exposing private keys to G9P writers.
