...
- **Deployment maturity — locally exercised:** automated integrated/separated custody, interruption, exact-byte backup/restore and offline-verification exercises pass; real MySQL/TLS and site-specific power-loss qualification remain deployment gates.
